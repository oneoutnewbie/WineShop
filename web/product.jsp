...
<%-- 
    Document   : product
    Created on : Feb 27, 2024, 10:20:10 PM
    Author     : acer
--%>
                            ...
                            <div id="top-functions-area" class="top-functions-area">
                                <form action="search" method="post">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="keyword" placeholder="Search by name..." value="${param['keyword']}">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img style="height: 23rem;" src="${o.img}" alt="IMG-PRODUCT">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 p-b-50">
                        ...
                        <p class="stext-107 cl7 size-201">
                            Any questions? Let us know in store at  FPT University,  Hoa lac,Ha Noi- 09888668843
                        </p>
                    ...
                    <div class="col-sm-6 col-lg-3 p-b-50">
                        ...
                        <form>
                            <div class="wrap-input1 w-full p-b-4">
                                <input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="nguyenminhhieu@example.com">
                ...
                <div class="p-t-40">
                    ...
                    <p class="stext-107 cl6 txt-center">
                        ...
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.facebook.com/profile.php?id=100072936291304" target="_blank">Hieu</a>
